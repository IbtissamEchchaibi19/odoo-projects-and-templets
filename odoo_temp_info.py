...
class WorksheetTemplateDesigner:
    ...
    def generate_worksheet_xml_informe(self, template_config: Dict[str, Any]) -> str:
        """Generate XML for Informe de Asistencia worksheet."""
        template_name = template_config['template_name']
    ...
    <sheet>
        ...
        <separator string="Contenido del Informe - Página 1"/>
        <group>
            <field name="x_report_content_page1" widget="text" nolabel="1" placeholder="Descripción de la asistencia, trabajo realizado, observaciones..."/>
        </group>
        
        <separator string="Contenido del Informe - Página 2"/>
        <group>
            <field name="x_report_content_page2" widget="text" nolabel="1" placeholder="Continuación del informe..."/>
        </group>
        
        <separator string="Contenido del Informe - Página 3"/>
        <group>
            <field name="x_report_content_page3" widget="text" nolabel="1" placeholder="Conclusiones, recomendaciones..."/>
        </group>
        
        <separator string="Realizado por"/>
        <group col="4">
            <field name="x_performed_by"/>
            <field name="x_position_dept_performed"/>
            <field name="x_date_performed"/>
            <field name="x_signature_performed"/>
        </group>
        
        <separator string="Aprobado por"/>
        <group col="4">
            <field name="x_approved_by"/>
            <field name="x_position_dept_approved"/>
            <field name="x_date_approved"/>
            <field name="x_signature_approved"/>
        </group>
    ...
    def generate_worksheet_xml(self, template_config: Dict[str, Any]) -> str:
        ...
        elif 'vibracion' in template_code.lower():
            return self.generate_worksheet_xml_vibracion(template_config)
        elif 'informe' in template_code.lower() or 'asistencia' in template_code.lower():
            return self.generate_worksheet_xml_informe(template_config)
        else:
